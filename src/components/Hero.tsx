  ...
  return (
    <section className="relative">
      <div className="relative h-[420px] sm:h-[500px] lg:h-[560px] overflow-hidden">
        ...
        <div style={{ position: "absolute", top: "239.6640625px" }} className="absolute left-[40px] bottom-0 translate-y-1/3 max-w-sm bg-[#F5F1EA] shadow-xl p-6 sm:p-7 h-max rounded-tr-2xl rounded-tl-[16px]">
